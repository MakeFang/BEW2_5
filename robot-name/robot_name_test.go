...
func BenchmarkName(b *testing.B) {
	...
	fmt.Println("number of raw rounds: ", b.N)
	// DOESN'T FUCKING WORK SINCE THE RAW ROUNDS GET TO ONE MILLION
	// WHICH IS MORE THAN THE NUMBER OF POSSIBLE COMBOS
	// THUS BENCHMARKING ALWAYS FAILS.
	for i := 0; i < b.N; i++ {
		New().getName(b, false)
	}
}
